...
// Look in a few places for the config file
module.exports = function (config) {
    try {
        console.log('Config file found successfully.')
        config.market = require('./../dynamicMarketConfig.js').settings
    } catch (e) {
        try {
            console.log('Config file found successfully.')
            config.market = require('dynamicMarketConfig.js').settings
            ...
            try {
                ...
                console.log('No dynamicMarketConfig.js file exists, reverting to defaults.')
