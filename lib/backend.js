                ...
                if (activeOrder) {
                    if (market.marketType !== 'dynamic') {
                        if (orders.sell[mineral]) {
                            ...
                            order.remainingAmount = market.sellAmount * playerTerminals.length
                            order.totalAmount = market.sellAmount * playerTerminals.length
                            order.amount = market.sellAmount * playerTerminals.length
                            if (market.marketType === 'random') {
                                let randomAmount = market.sellAmount * (Math.random() * (+1.2 - +0.8) + +0.8) * playerTerminals.length
                        ...
                        if (orders.buy[mineral]) {
                            ...
                            order.created = gameTime
                            order.createdTimestamp = nowTimestamp
                            order.remainingAmount = market.buyAmount * playerTerminals.length
                            order.totalAmount = market.buyAmount * playerTerminals.length
                            order.amount = market.buyAmount * playerTerminals.length
                            if (market.marketType === 'random') {
                                let randomAmount = market.buyAmount * (Math.random() * (+1.2 - +0.8) + +0.8) * playerTerminals.length
                                order.remainingAmount = randomAmount
                                order.totalAmount = randomAmount
                                order.amount = randomAmount
                        ...
                        if (orders.buy[mineral]) {
                            ...
                            if (commodityTiers[0].includes(mineral)) {
                                saturationPoint = (market.saturationPoint * (Math.random() * (+0.95 - +0.85) + +0.85)) * Math.ceil(playerTerminals.length * 0.5)
                            } else if (commodityTiers[1].includes(mineral)) {
                                saturationPoint = (market.saturationPoint * (Math.random() * (+0.8 - +0.65) + +0.65)) * Math.ceil(playerTerminals.length * 0.5)
                            } else if (commodityTiers[2].includes(mineral)) {
                                saturationPoint = (market.saturationPoint * (Math.random() * (+0.6 - +0.35) + +0.35)) * Math.ceil(playerTerminals.length * 0.5)
                            } else if (commodityTiers[3].includes(mineral)) {
                                saturationPoint = (market.saturationPoint * (Math.random() * (+0.4 - +0.2) + +0.2)) * Math.ceil(playerTerminals.length * 0.5)
                            } else if (commodityTiers[4].includes(mineral)) {
                                saturationPoint = (market.saturationPoint * (Math.random() * (+0.25 - +0.05) + +0.05)) * Math.ceil(playerTerminals.length * 0.5)
                            }
